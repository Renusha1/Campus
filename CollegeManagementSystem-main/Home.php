    ...
    <style>
        ...
        * {
        ...
        .floating-text {
            ...
            /* Adjust line height */
            max-width: 80%;
            /* Prevent text from stretching too much */
            padding: 10px;
...
<body>
    ...
    <section>
        <div class="floating-text">
            <h2>Transform your campus experience with our seamless and efficient College Management System – all your
                tasks in one place!</h2>
        </div>
    </section>
    <footer>
